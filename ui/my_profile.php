    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
                                            ...
                                            <div class="profile-info">
                                                ...
                                                <div class="profile-details">
                                                    <div class="profile-name px-3 pt-2">
                                                        <h4 class="text-primary mb-0"><?php echo $rows['blood_donor_names']; ?></h4>
                                                        <p><?php echo $rows['login_rank']; ?></p>
                                                    </div>
                                                    <div class="profile-email px-2 pt-2">
                                                        <h4 class="text-muted mb-0"><?php echo $rows['blood_donor_email']; ?></h4>
                                                        <p>Email</p>
                                                    </div>
                                                </div>
                                            </div>
        ...
        } else if ($login_rank == 'Patient') {
            $fetch_records_sql = mysqli_query(
                $mysqli,
                "SELECT * FROM patient p
                INNER JOIN login l ON
                l.login_id = p.patient_login_id WHERE l.login_id = '{$login_id}'"
            );
            if (mysqli_num_rows($fetch_records_sql) > 0) {
                while ($rows = mysqli_fetch_array($fetch_records_sql)) { ?>
                    <div class="content-body">
                                    ...
                                    <div class="profile card card-body px-3 pt-3 pb-0">
                                        <div class="profile-head">
                                            ...
                                            <div class="profile-info">
                                                ...
                                                <div class="profile-details">
                                                    <div class="profile-name px-3 pt-2">
                                                        <h4 class="text-primary mb-0"><?php echo $rows['patient_names']; ?></h4>
                                                        <p><?php echo $rows['login_rank']; ?></p>
                                                    </div>
                                                    <div class="profile-email px-2 pt-2">
                                                        <h4 class="text-muted mb-0"><?php echo $rows['patient_email']; ?></h4>
                                                        <p>Email</p>
                                                    </div>
                                                </div>
                                            </div>
