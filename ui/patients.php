        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="form-head align-items-center d-flex mb-sm-4 mb-3">
                    ...
                    <div>
                        <a href="javascript:void(0)" class="btn btn-primary mr-3" data-toggle="modal" data-target="#add_modal">+ New Patient</a>
                    </div>
                </div>
                <!-- Add Modal -->
                                ...
                                <form class="needs-validation" method="post" enctype="multipart/form-data" role="form">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" required name="patient_names" class="form-control">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="">Contacts</label>
                                            <input type="text" required name="patient_contacts" class="form-control">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="">Email</label>
                                            <input type="text" required name="patient_email" class="form-control">
                                        </div>
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="text-right">
                                        <button type="submit" name="Add_Patient" class="btn btn-outline-danger">Save</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                    ...
                                    <table id="example3" class="display min-w850">
                                        ...
                                        <tbody>
                                            ...
                                            $fetch_records_sql = mysqli_query(
                                                ...
                                                l.login_id = p.patient_login_id"
                                            );
                                            if (mysqli_num_rows($fetch_records_sql) > 0) {
                                                while ($rows = mysqli_fetch_array($fetch_records_sql)) {
                                            ?>
                                                    <tr>
                                                        <td><?php echo $rows['patient_names']; ?></td>
                                                        <td><?php echo $rows['patient_email']; ?></td>
                                                        <td><?php echo $rows['patient_contacts']; ?></td>
                                                        <td><?php echo $rows['patient_blood_group']; ?></td>
                                                        <td><?php echo $rows['patient_address']; ?></td>
                                                        <td>
                                                            <div class="d-flex">
                                                                <a data-toggle="modal" href="#edit_<?php echo $rows['patient_id']; ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                                                <a data-toggle="modal" href="#delete_<?php echo $rows['patient_id']; ?>" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                            <?php
                                                    include('../app/modals/patients.php');
                                                }
                                            } ?>
                                        </tbody>
                                    </table>
