            ...
            <div class="container-fluid">
                <div class="form-head align-items-center d-flex mb-sm-4 mb-3">
                    <div class="mr-auto">
                        ...
                        <p class="mb-0">Manage vet clininc clients</p>
                    </div>
                    <div>
                        <a href="javascript:void(0)" class="btn btn-primary mr-3" data-toggle="modal" data-target="#add_modal">+ New Client</a>
                    </div>
                </div>
                <!-- Add Modal -->
                                ...
                                <form class="needs-validation" method="post" enctype="multipart/form-data" role="form">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" required name="client_address" class="form-control">
                                        </div>
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="text-right">
                                        <button type="submit" name="Add_Client" class="btn btn-outline-danger">Save</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <a data-toggle="modal" href="#edit_<?php echo $rows['client_id']; ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                                                <a data-toggle="modal" href="#delete_<?php echo $rows['client_id']; ?>" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                            <?php
                                                    include('../app/modals/clients.php');
                                                }
                                            } ?>
                                        </tbody>
                                    </table>
