...
if (isset($_POST['Update_Treatment'])) {
    $treatment_id = mysqli_real_escape_string($mysqli, $_POST['treatment_id']);
    ...
    /* Update */
    $update_sql = "UPDATE treatments SET treatment_details = '{$treatment_details}', treatment_date = '{$treatment_date}',
    treatment_cost = '{$treatment_cost}' wHERE treatment_id = '{$treatment_id}'";
...
if (isset($_POST['Delete_Treatment'])) {
    ...
    /* Delete */
    $delete_sql = "DELETE FROM treatments WHERE treatment_id = '{$treatment_id}'";

    if (mysqli_query($mysqli, $delete_sql)) {
        $success = "Treatment deleted";
    } else {
        $err = "Failed, please try again";
    }
}
...
if (isset($_POST['Delete_Payment'])) {
    ...
    $payment_treatment_id = mysqli_real_escape_string($mysqli, $_POST['payment_treatment_id']);

    /* Delete & Roll Back */
    $delete_sql = "DELETE FROM payments WHERE payment_id = '{$payment_id}'";
    $update_sql = "UPDATE treatments SET treatment_status = 'Pending' WHERE treatment_id = '{$payment_treatment_id}'";
